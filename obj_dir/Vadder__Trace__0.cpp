...
void Vadder___024root__trace_chg_0_sub_0(Vadder___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelf->adder_tb__DOT__a));
    bufp->chgBit(oldp+1,(vlSelf->adder_tb__DOT__b));
    bufp->chgBit(oldp+2,(((IData)(vlSelf->adder_tb__DOT__a) 
                          ^ (IData)(vlSelf->adder_tb__DOT__b))));
    bufp->chgBit(oldp+3,(((IData)(vlSelf->adder_tb__DOT__a) 
                          & (IData)(vlSelf->adder_tb__DOT__b))));
}
